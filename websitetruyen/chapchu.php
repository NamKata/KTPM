                ...
                <div class="box">
                    <div id="path" class="path-top">
                        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                <a itemprop="item" href="chapchu.php?matruyen=<?php echo $chitietchap["Manga"] ?>&sttchap=<?php echo $chitietchap['SttChap'] ?>">
                    ...
                    <h1 class="detail-title"><a href="chapchu.php?matruyen=<?php echo $chitietchap["Manga"] ?>&sttchap=<?php echo $chitietchap['SttChap'] ?>"><?php echo $chitietchap["TenManga"]; ?></a> Chap <?php echo $chitietchap["SttChap"] ?></h1>
                </div>
...
<br />                </div> -->
                ...
                <div class="story-detail has-background-white on">
                    ...
                    <div class="comment-container">
                        ...
                        <div id="fb-root"></div>
                        <div class="fb-comments" data-href="https://www.youtube.com/watch?v=2_RG5BjQ-LE" data-numposts="5" data-width=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="level">
      ...
      <div class="center level">
        ...
        <select class="selectEpisode">
          <option value="chapchu.php?matruyen=1&sttchap=1" selected
            >Chương 1</option
          >
          <option value="chapchu.php?matruyen=1&sttchap=2"
            >Chương 2</option
          >
          <option value="chapchu.php?matruyen=1&sttchap=3"
            >Chương 3</option
          >
          <option value="chapchu.php?matruyen=1&sttchap=4"
            >Chương 4</option
          >
        </select>
