            ...
            ?>
              <div class="top-buttons has-login">
                ...
                <div class="notify center" data-id="notification">
                  ...
                  ?>
                    <i class="fas fa-shopping-cart"></i> <span><?php echo count($_SESSION["cart_items"]) ?> </span>
                    <div class="list-messages">
                      <div class="title-message">Giỏ hàng của bạn</div>
                      <ul style="padding: 10px;">
                        ...
                        ?>
                          <li class="message" style="display:flex;">
                            <div style="height: 75px; width:30%;">
                              <img src="Images/Product/vip1.png" width="100%" height="100%">
                            </div>
                            <div style="height:75px; width:70%; padding: 5px; display:block;">
                              <p><?php echo $prod["TenSanpham"] ?> x <?php echo $item["quantity"] ?></p>
                              <p>Giá:<?php echo number_format($prod["Gia"]) ?> đ</p>
                            </div>
                          </li>
                        <?php
                        }
                      ...
                      <p class="pull-right">Tổng : <?php echo number_format($total_money) ?>đ</p>
                      <br />
                      <a href="shopping_cart.php" class="btn btn-primary">Xem giỏ hàng</a>
                ...
                <div class="notify user center">
                 <?php
                      $thongtintaikhoan=User::ThongTinNguoiDung($_SESSION['user']);
                      $thongtintaikhoan= reset($thongtintaikhoan);
                     ?>
                  <span class="avatar-menu"><img src="<?php echo $thongtintaikhoan['Anh'] ?>" /></span>
                  <div class="notify btn-user smp">
                    <i class="fas fa-user-circle"></i>
                  </div>
                  <ul class="user-links">
                    <li>
                      <a href="thongtincanhan.php?matk=<?php echo $_SESSION["user"] ?>"><i class="fas fa-user-circle"></i> Thông tin tài khoản </a>
                    </li>
                    <li>
                      <a href="#"><i class="fas fa-heart"></i> Theo dõi</a>
                    </li>
                    <?php 
                    ...
                    ?>
                    <li>
                      <a href="dangtruyen.php"><i class="fas fa-history"></i> Đăng Truyện</a>
                    </li>
                    <?php } else {} ?>
                    <li>
                      <a href="tutruyen.php?matk=<?php echo $_SESSION["user"]; ?>"><i class="fas fa-envelope"></i> Tủ Truyện</a>
                    </li>
                    <li>
        ...
        <nav class="navbar">
          <div class="navbar-menu">
            <div class="navbar-start">
                        ...
                        <div class="columns">
                          <div class="column column-menu">
                            <ul class="mega-list">
                              ...
                              ?>
                                <li class="col-sm-3">
                                  <a href="danhsachtheloai.php?IdTheloai=<?php echo $item["IdTheloai"] ?>"><?php echo $item['TenTheloai'] ?></a>
                                </li>
                              <?php } ?>
                            </ul>
                          </div>
              ...
              <a href="mualuotdang.php" class="navbar-item">Mua lượt đăng</a>
